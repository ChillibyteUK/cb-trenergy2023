...
function widgets_init()
{
    // register_sidebar(
    //     array(
    //         'name'          => __('Footer Col 1', 'cb-trenergy2023'),
    //         'id'            => 'footer-1',
    //         'description'   => __('Footer Col 1', 'cb-trenergy2023'),
    ...
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'cb-trenergy2023'),
    ));

    register_nav_menus(array(
        'footer_menu1' => __('Footer Menu 1', 'cb-trenergy2023'),
    ));
    register_nav_menus(array(
        'footer_menu2' => __('Footer Menu 2', 'cb-trenergy2023'),
    ));
